...
---@alias twilight.types.ColorSpec { [1]: Color, [2]: Color, link: string, reverse: boolean }
---@alias twilight.types.HLGroups { [string]: twilight.types.ColorSpec }

---@param theme twilight.types.Theme
---@param config twilight.types.Config
function M.setup(theme, config)
  ---@type twilight.types.HLGroups
  local hl_groups = {
  ...
  if config.override_terminal then
    require 'twilight-moon.hl.terminal'(theme, theme.colors)
  end
